            ...
            <div class="flex flex-col gap-5 sm:col-span-2 sm:flex-row lg:col-span-1 lg:flex-col lg:pt-20">
                ...
                <div class="reveal grain relative flex flex-col overflow-hidden rounded-3xl bg-navy text-white sm:flex-1 lg:flex-none">
                    ...
                    <div class="relative -mt-4 p-8 pt-6">
                        <p class="font-display text-[1.45rem] font-medium leading-snug">Your next step,<br><em class="text-accent-300">a conversation.</em></p>
                        <a href="{{ route('contact') }}#contact" class="mt-6 inline-flex text-sm font-semibold text-accent-300 underline underline-offset-4">Request an appointment</a>
                    </div>
                </div>
            </div>
        </div>
