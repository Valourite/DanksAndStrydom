...
<section id="about" class="relative overflow-hidden py-24 sm:py-28 lg:pb-36">
    <div data-parallax="0.1" class="pointer-events-none absolute -right-40 top-16 -z-10 h-112 w-md rounded-full bg-accent-100/60 blur-3xl will-change-transform"></div>
    ...
    <div class="mx-auto grid max-w-6xl items-center gap-16 px-5 sm:px-8 lg:grid-cols-[0.92fr_1.08fr] lg:gap-20">
        ...
        <div class="reveal relative order-last mx-auto w-full max-w-md lg:order-first lg:max-w-none">
                ...
                <div class="relative -mt-7 px-8 pb-9 sm:px-9">
                    ...
                    <div class="mt-8 grid grid-cols-2 gap-3">
                        ...
                        <div class="rounded-2xl border border-surface-50/10 bg-surface-50/5 p-4 text-center backdrop-blur-sm">
                            ...
                            <p class="mt-1 text-[0.68rem] leading-snug text-ink-300">Physiotherapists</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- Offset sand card --}}
            <div class="animate-drift-slow absolute -right-5 -top-4 hidden rounded-2xl bg-surface-200 px-5 py-4 shadow-[0_20px_45px_-22px_rgba(var(--shadow-ink),0.35)] sm:block">
                <p class="font-display text-lg font-medium text-ink-900">Surgiklin Studios</p>
                <p class="mt-0.5 text-[0.7rem] text-ink-700">Suite 102 · Glen Eagle Office Park</p>
            </div>
        </div>
        ...
        <div class="reveal">
            ...
            <a href="{{ isset(\App\Support\Site::pages()['about']) ? route('about') : route('contact').'#contact' }}" class="group mt-10 inline-flex items-center gap-3 rounded-full border border-ink-900/15 py-3 pl-6 pr-3 text-sm font-semibold text-ink-900 transition-all duration-300 hover:border-ink-900 hover:bg-brand hover:text-white">
                {{ isset(\App\Support\Site::pages()['about']) ? 'Meet the physiotherapists' : 'Contact the practice' }}
                <span class="flex h-8 w-8 items-center justify-center rounded-full bg-brand text-white transition-colors duration-300 group-hover:bg-accent-500">
