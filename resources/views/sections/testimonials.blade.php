    ...
    <div class="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="flex flex-col gap-5">
                ...
                <x-site.testimonial-card :name="$testimonials[1]['name']" :detail="$testimonials[1]['detail']" style="--reveal-delay: 90ms">
            ...
            <div class="flex flex-col gap-5 lg:pt-10">
                <x-site.testimonial-card :name="$testimonials[2]['name']" :detail="$testimonials[2]['detail']" style="--reveal-delay: 140ms">
                    {{ $testimonials[2]['quote'] }}
                </x-site.testimonial-card>
                <x-site.testimonial-card :name="$testimonials[3]['name']" :detail="$testimonials[3]['detail']" style="--reveal-delay: 200ms">
            ...
            <div class="flex flex-col gap-5 sm:col-span-2 sm:flex-row lg:col-span-1 lg:flex-col lg:pt-20">
                <x-site.testimonial-card class="sm:flex-1 lg:flex-none" :name="$testimonials[4]['name']" :detail="$testimonials[4]['detail']" style="--reveal-delay: 240ms">
                    {{ $testimonials[4]['quote'] }}
                </x-site.testimonial-card>

                {{-- Closing CTA tile --}}
                <div class="reveal grain relative flex flex-col justify-center overflow-hidden rounded-3xl bg-pine-950 p-8 text-bone-50 sm:flex-1 lg:flex-none" style="--reveal-delay: 300ms">
                    <div class="pointer-events-none absolute -right-12 -top-12 h-40 w-40 rounded-full bg-sea-500/25 blur-2xl"></div>
                    ...
                    <a href="#contact" class="group relative mt-6 inline-flex w-fit items-center gap-2 text-sm font-semibold text-sea-300 transition-colors hover:text-bone-50">
                        Book an appointment
