    ...
    <div class="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="flex flex-col gap-5 sm:col-span-2 sm:flex-row lg:col-span-1 lg:flex-col lg:pt-20">
                <x-site.testimonial-card class="flex-1" :name="$testimonials[4]['name']"
                ...
                <div class="reveal grain relative flex flex-col overflow-hidden rounded-3xl bg-pine-950 text-bone-50 sm:flex-1 lg:flex-none hover:-translate-y-1 hover:shadow-[0_24px_50px_-26px_rgba(10,31,27,0.35)]"
                    ...
                    <div class="relative h-44 overflow-hidden sm:h-48 lg:h-40">
                        <img
                            src="{{ asset('images/electrotherapy.webp') }}"
                            alt="Electrotherapy pads being positioned during physiotherapy treatment"
                            width="1200"
                            height="900"
                            loading="lazy"
