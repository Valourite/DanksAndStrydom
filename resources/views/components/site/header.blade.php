...
>
    <nav class="mx-auto flex h-20 max-w-6xl items-center justify-between gap-4 px-5 sm:px-8 lg:h-24" aria-label="Primary">
        ...
        {{-- Wordmark --}}
        <a href="#hero" class="flex items-center gap-3.5" aria-label="Danks &amp; Strydom Physiotherapy — home">
            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-pine-900/15 bg-bone-50 font-display text-[0.95rem] font-semibold tracking-tight text-pine-900 transition-colors duration-300 group-hover/header:border-pine-900/15">
        ...
        <button
            ...
            class="group/btn -mr-1 inline-flex h-12 w-12 items-center justify-center rounded-full text-pine-900 transition-colors hover:bg-pine-900/5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sea-600 lg:hidden">
            <svg class="h-6 w-6 group-aria-expanded/btn:hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" aria-hidden="true">
                <path d="M4 8h16M4 16h10"/>
            </svg>
            <svg class="hidden h-6 w-6 group-aria-expanded/btn:block" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" aria-hidden="true">
    ...
    {{-- Mobile menu --}}
    <div id="mobile-menu" data-menu-panel class="hidden lg:hidden">
